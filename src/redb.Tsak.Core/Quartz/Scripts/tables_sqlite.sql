-- Quartz.NET AdoJobStore schema for SQLite.
-- Idempotent: uses CREATE TABLE/TRIGGER IF NOT EXISTS — applied on every startup,
-- existing Quartz state is preserved (same semantics as tables_postgres.sql).
